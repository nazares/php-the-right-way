---
title: Используйте текущую стабильную версию (8.4)
isChild: true
anchor: use_the_current_stable_version
---

## Используйте текущую стабильную версию (8.4) {#use_the_current_stable_version_title}

Если вы начали работать с PHP, начните с текущего стабильного релиза [PHP 8.4][php-release]. PHP 8.x добавляет много
...
[End of Life][php-supported]. Обновление - это просто, тут не так много
 [PHP 8.1][php-bc-81], [PHP 8.2][php-bc-82], [PHP 8.3][php-bc-83], [PHP 8.4][php-bc-84]. Если вы не уверены в какой версии содержится функция или особенность,
