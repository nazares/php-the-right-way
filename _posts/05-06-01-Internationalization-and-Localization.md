...
- [php-gettext/Gettext][php-gettext]: поддержка Gettext с ОО интерфейсом; включая улучшенные вспомогательные функции, мощные
...
вашей системы; он доступен для Unix, macOS и Windows, а также может быть [бесплатно загружен на их веб-сайте][poedit_download].
...
- Source paths: здесь вы должны включить все папки из проекта, где вызывается `gettext()` (и родственные) - обычно это
...
[php-gettext от Gettext][php-gettext], также предоставляют подобные вспомогательные функции.
